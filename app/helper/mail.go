...
func (template *MailTemplate) GetTextMailCreatorByKey(key string, data pkg.BindData) (creator pkg.MailCreator, parse string, err error) {
	var information MailTemplateInformation
...
func (template *MailTemplate) GetHTMLMailCreatorByKey(key string, data pkg.BindData) (creator pkg.MailCreator, parse string, err error) {
	var information MailTemplateInformation
	creator, information, err = template.createMailCreatorAndInformationByKey(key, data)
